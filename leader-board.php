                                        ...
                                        <div class="table-content">
                                            <?php for ($i = 0; $i < count($fscore); $i++): ?>
                                                <div class="table-row paged2" id="<?php echo 'page2_' . $i; ?>" data-pageid2="<?php echo $i; ?>">
                                                    ...
                                                    <div class="col-99 col-text-black"><?php echo $fscore[$i]['username']==""?"User":$fscore[$i]['username']; ?></div>
...
<div class="modal fade" id="leave-league"tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            ...
            <div class="modal-body">
                <div class="table-responsive datatable">
                    <table class="table table-bordered table-hover" id="leaguelistleave">
                        <thead>
                            <tr style="background: bisque;">
                                <th>Si</th>
                                <th>Group Name</th>
                        ...
                        <tbody>
                            <?php for ($i = 0; $i < count($allprivateleague['data']); $i++): ?>
                                <tr>
                                    <td><?php echo $i + 1; ?></td>
                                    <td><?php echo $allprivateleague['data'][$i]['groupname']; ?></td>
                                    <td><?php echo '<button  class="btn btn-primary btn-sm leagueleave" data-leagueid='.$allprivateleague['data'][$i]['groupid'].'>Leave</button>'; ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
